      ...
      {data.map((item, index) => (
        ...
        >
          ...
          <div className="absolute top-0 left-0 h-full flex items-center px-4 sm:px-6 md:px-10 lg:pl-[10%] xl:pl-[17%] 2xl:pl-[25%]">
            <div className="max-w-[150px] sm:max-w-[180px] md:max-w-[240px] lg:max-w-[310px]">
              <h1
                className={`text-[14px] sm:text-lg md:text-[28px] font-medium lg:text-[34px] xl:text-[36px] md:leading-9 lg:leading-11 text-white mb-5 transform transition-all duration-700 ${
                  index === currentIndex
