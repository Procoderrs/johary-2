...
export default function Privacypolicy() {
  ...
  return (
    <div className="font-user">
      ...
      {/* ================= CONTENT ================= */}
      <div className="w-full px-6 py-16 space-y-12 text-[#666] border-b border-[#f1efea]">

        {/* SECTION */}
        <div className="space-y-4">
          <h2 className="text-black text-xl font-semibold">Who we are</h2>
          <p>Our website address is: http://example.com</p>
        </div>

        {/* SECTION */}
        <div className="space-y-4">
          <h2 className="text-black text-3xl font-medium">Comments</h2>
        ...
        {/* SECTION */}
        <div className="space-y-4">
          <h2 className="text-black text-3xl font-medium">Media</h2>
        ...
        {/* SECTION */}
        <div className="space-y-4">
          <h2 className="text-black text-3xl font-medium">Cookies</h2>
